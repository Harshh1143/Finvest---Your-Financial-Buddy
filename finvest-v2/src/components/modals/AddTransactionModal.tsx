...
interface AddTransactionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (data: FormValues) => Promise<void>;
}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl backdrop-blur-md"
          >
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              ...
              <button
                onClick={onClose}
                className="rounded-full border border-white/10 p-1.5 text-slate-400 hover:text-white transition bg-white/5"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    placeholder="0.00"
                    className="w-full rounded-2xl border border-white/10 bg-white/5 py-3.5 pl-11 pr-4 text-sm text-white placeholder-slate-500 outline-none transition focus:border-cyan-400/50 focus:bg-white/10"
                  />
                </div>
                {errors.amount && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    {...register("date")}
                    type="date"
                    className="w-full rounded-2xl border border-white/10 bg-white/5 py-3.5 pl-11 pr-4 text-sm text-white placeholder-slate-500 outline-none transition focus:border-cyan-400/50 focus:bg-white/10 [color-scheme:dark]"
                  />
                </div>
                {errors.date && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    {...register("category")}
                    className="w-full rounded-2xl border border-white/10 bg-white/5 py-3.5 pl-11 pr-4 text-sm text-white outline-none transition focus:border-cyan-400/50 focus:bg-white/10 [color-scheme:dark] appearance-none"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full rounded-2xl border border-white/10 bg-white/5 py-3.5 pl-11 pr-4 text-sm text-white placeholder-slate-500 outline-none transition focus:border-cyan-400/50 focus:bg-white/10 resize-none"
                  />
                </div>
                {errors.description && (
              ...
              <div className="flex gap-3 mt-6">
                <Button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-5 rounded-xl border border-white/10 bg-transparent text-slate-300 hover:bg-white/5 hover:text-white"
                >
                  Cancel
                </Button>
                <Button
                  ...
                  className="flex-1 py-5 rounded-xl font-semibold bg-cyan-500 hover:bg-cyan-600 text-slate-950"
                >
