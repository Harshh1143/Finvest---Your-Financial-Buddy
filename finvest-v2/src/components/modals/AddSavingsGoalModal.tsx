...
export function AddSavingsGoalModal({ isOpen, onClose, onSuccess }: AddSavingsGoalModalProps) {
  const {
    register,
    handleSubmit,
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl backdrop-blur-md"
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                {errors.target_amount && (
                  <p className="text-xs text-red-400">{errors.target_amount.message}</p>
                )}
              </div>
