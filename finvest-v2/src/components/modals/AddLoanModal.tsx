          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    {...register("name")}
                    type="text"
                    placeholder="e.g. Student Loan, Auto Mortgage"
              ...
              <div className="space-y-2">
                ...
                {errors.principal && (
                  <p className="text-xs text-red-400">{errors.principal.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.tenure_months && (
                  <p className="text-xs text-red-400">{errors.tenure_months.message}</p>
                )}
              </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <Button
                  ...
                  className="flex-1 py-5 rounded-xl font-semibold bg-violet-600 hover:bg-violet-700 text-white"
                >
