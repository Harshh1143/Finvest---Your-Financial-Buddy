...
const features = [
  {
    ...
    description:
      "See every inflow and outflow in one calm, gorgeous workspace.",
    icon: BrainCircuit,
  },
  {
    title: "Goal-driven planning",
    description:
      "Model large milestones and keep momentum visible with smart projections.",
    icon: TrendingUp,
  },
  {
    title: "Bank-grade trust",
    description:
      "Your data stays protected with encryption by default and audit-friendly controls.",
    icon: ShieldCheck,
  },
];
